...
| 7.54 | `products` guarda **valor simples** (sem série de vigências) e o **valor aplicado fica no lançamento**; um lançamento aceita **um item** (procedimento **ou** produto) | Repetir a série de vigências dos procedimentos aqui seria complexidade sem retorno enquanto o preço do produto não for reajustado com frequência — e, como o lançamento grava o valor aplicado, o histórico já nasce correto. Se a clínica pedir histórico de preço de produto, aplica-se o padrão de vigência depois (aditivo, sem migração de dados). Já "venda com vários itens" mudaria relatórios, conciliação e tela: fica como decisão explícita quando a clínica vender combo com frequência. |
