...
export class FinancialController {
  ...
  @Delete('transactions/:id') @Roles('ADMIN') remove(@Param('id',ParseUUIDPipe) id:string,@Body() dto:DeleteFinancialTransactionDto,@CurrentUser() user:AuthenticatedUser,@Headers('x-request-id') requestId?:string){return this.transactions.remove(id,user,requestId||randomUUID(),dto.reason);}
